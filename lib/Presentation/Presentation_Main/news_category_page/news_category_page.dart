...
class NewsCategoryPage extends StatefulWidget {
  const NewsCategoryPage({Key? key}) : super(key: key);

  @override
  NewsCategoryPageState createState() => NewsCategoryPageState();

  static Widget builder(BuildContext context) {
    return BlocProvider<NewsCategoryBloc>(
      create: (context) => NewsCategoryBloc(NewsCategoryState(
        newsCategoryModelObj: NewsCategoryModel(),
      ))
        ..add(NewsCategoryInitialEvent()),
      child: NewsCategoryPage(),
    );
  }
}

class NewsCategoryPageState extends State<NewsCategoryPage>
    with AutomaticKeepAliveClientMixin<NewsCategoryPage> {
  @override
