...
import 'bloc/leisure_category_bloc.dart';
...
class LeisureCategoryPage extends StatefulWidget {
  const LeisureCategoryPage({Key? key}) : super(key: key);

  @override
  LeisureCategoryPageState createState() => LeisureCategoryPageState();

  static Widget builder(BuildContext context) {
    return BlocProvider<LeisureCategoryBloc>(
      create: (context) => LeisureCategoryBloc(LeisureCategoryState(
        leisureCategoryModelObj: LeisureCategoryModel(),
      ))
        ..add(LeisureCategoryInitialEvent()),
      child: LeisureCategoryPage(),
    );
  }
}

class LeisureCategoryPageState extends State<LeisureCategoryPage>
    with AutomaticKeepAliveClientMixin<LeisureCategoryPage> {
  @override
